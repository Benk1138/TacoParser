...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var corA = new GeoCordinate();
            corA.Latitude = locA.Location.longitude;
            corA.Longuitude = locA.Location.longitude;
            ...
            logger.LogInfo($"{tacoBell1.Name} and {tacoBell2.Name} are the fartherest apart");
